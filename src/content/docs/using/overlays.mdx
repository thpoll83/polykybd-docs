...
<Aside type="tip">
**Ctrl+Alt+Shift and the GUI/Win key are shown too.** Older releases could not display
either — Ctrl+Alt+Shift had nowhere to store its images, and GUI overlays were discarded
before reaching the keyboard. Both work now, so app overlays can cover those shortcuts.
</Aside>
