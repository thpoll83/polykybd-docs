...
| `logs bundle\|show\|paths` | Collect the log files — write a support `.zip`, print recent lines, or list what was found. **Works with the host stopped** — see [Reporting a Problem](/software/reporting-problems/) |
