...
- The **main legend**, drawn largest and to the left — what the key types on its own. Just how
  large is [adjustable](/using/legend-size/); these examples use the default.
