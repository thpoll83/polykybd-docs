...
<Aside type="caution">
Each half has only **two** expansion slots, so the rotary encoder, a pointing device
(trackball/trackpad) and the light sensor compete for space — you can fit **at most two** of them on
the same half, never all three. Decide which two you want before you start.
</Aside>
