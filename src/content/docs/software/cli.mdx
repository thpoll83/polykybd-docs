...
| `idle-timeout [15sec\|30sec\|45sec\|1min\|2min\|5min]` | Get or set [how long before the keycaps start fading](/using/idle/#how-long-before-it-idles) — the delay before the style above engages, not the display-off deadline |
