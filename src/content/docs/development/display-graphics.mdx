...
- **Display driver**: integrated into `keyboards/handwired/polykybd/` (`base/disp_array.c`, `poly_keymap.c`) in the QMK firmware fork
...
```sh
cd keyboards/handwired/polykybd/fonts
