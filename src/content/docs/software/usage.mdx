...
- [Context-Aware Overlays](/features/overlays/) — the keycaps follow your active window automatically.
- [Display Brightness](/features/brightness/) — manual, adaptive-daylight (**Settings → Brightness**), or the optional light sensor.
- [Languages & Unicode Input](/firmware/unicode/) — the OS unicode mode selected on the keyboard is synced here, and settable from the Settings dialog.
- [Glyph Scripts](/features/glyph-scripts/) — theme the legends from the **Glyph Script** submenu.
