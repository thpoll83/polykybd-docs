...
(symbols, Middle-Eastern, syllabic, Asian, flags, emoji, the `fantasy` script bundle, and
`latinbig`, which carries the bigger faces for the [legend size](/using/legend-size/)).
