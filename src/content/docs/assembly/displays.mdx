...
Extended modules ready to fit — the glass is small, most of the length is the flex tail that has to
reach the socket:

![A row of 0.42-inch OLED modules laid out, each with its FPC tail extended](../../../assets/assembly/display-modules.jpg)
