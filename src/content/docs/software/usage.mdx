...
| Entry | What it does |
|---|---|
| *Status line* | The connected keyboard and its firmware. Click it to pause/resume. |
| **Pause** | Stop talking to the keyboard (it keeps typing; the overlays just stop updating). |
