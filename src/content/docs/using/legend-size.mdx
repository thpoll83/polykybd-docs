...
Here is the same thing on a real layout — five French (AZERTY) keys at each size. The
accented letter each key produces grows; the small **Shift** and **AltGr** previews beside it
stay exactly where they are.

![Five French AZERTY keycaps — é, è, ç, à and a — drawn at all three legend sizes, with their Shift and AltGr previews unchanged](../../../assets/using/legend-sizes-french.png)
