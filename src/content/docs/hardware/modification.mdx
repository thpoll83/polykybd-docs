...
- `parts/cirque_insert/cirque35_insert.scad` — 35mm trackpad insert, for the [recommended pad](/assembly/parts-list/#pointing-devices-choose-one) (ready STL: `parts/export/cirque_insert/cirque35_insert_r3_4p.stl`, a four-up plate)
...
Three part groups have a **build script** instead, because they are parameterised or generated
and exporting them by hand is how an export falls a revision behind its source:
...
Each re-exports idempotently: OpenSCAD emits facets in an unstable order and different builds of
