...
![PolyKybd Split72](../../../assets/assembly/PolyKybdSplit72p.jpg)

The PolyKybd Split72 can be assembled in a few different ways depending on how much of the build you want to do yourself.

A finished pair — both halves joined by the link cable, the right one fitted with a trackball in its
expansion slot:

![Both Split72 halves on a desk, connected by the link cable, keycap OLEDs showing their legends](../../../assets/assembly/split72-both-halves.jpg)

In profile, so you can judge the height the case and keycaps add:

![Side view of an assembled Split72 half showing the case height and keycap profile](../../../assets/assembly/split72-profile.jpg)
...
- 72× custom 3D-printed key stems ([three profiles to choose from](/assembly/keycap-stems/))
