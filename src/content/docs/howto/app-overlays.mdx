...
| `*.extra.mods.png` (extra) | Ctrl+Alt+Shift | *reserved* | *reserved* | *reserved* |
...
- **All nine modifier variants work**, including Ctrl+Alt+Shift and the GUI/Win key. Earlier
  releases dropped both — if you skipped those shortcuts before, you can add them now.
...
4. **Export the PNG(s).** Export the image to `polyhost/res/overlays/<app>_template.mods.png` as
   720×360 RGBA. Add a `<app>_template.extra.mods.png` only if you drew Ctrl+Alt+Shift, and a
   `<app>_template.combo.mods.png` only if you drew combo (Ctrl+Shift / Ctrl+Alt
