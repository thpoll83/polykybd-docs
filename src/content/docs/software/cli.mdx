...
| `idle-style [pulse\|jitter]` | Get or set the [idle anti-burn-in style](/features/idle/) |
| `glyph-script [standard\|tengwar\|…]` | Get or set the [glyph-script](/features/glyph-scripts/) legend override |
