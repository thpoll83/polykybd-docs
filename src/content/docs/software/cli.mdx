...
| `brightness --auto` | Hand brightness back to [automatic](/using/brightness/) (a manual level otherwise sticks until you do) |
...
| `settings get <key>` / `settings set <key> <value>` | Read or change a setting (e.g. `settings set developer_mode true`) |
