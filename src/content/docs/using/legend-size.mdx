...
and digits grow; the small **Shift** and **AltGr** previews beside them, and every icon key
(modifiers, arrows, layer keys), stay exactly as they are.

![A full split72 keyboard on the French AZERTY layout, drawn three times at the small, medium and large legend sizes](../../../assets/using/legend-size-board-french.png)
