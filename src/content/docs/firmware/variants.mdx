...
A split72 half — 36 keys, the 128×64 status OLED at the top left, and a Cirque trackpad in the
expansion slot:

![An assembled split72 right half, every keycap OLED lit with its legend, status OLED reading "1 RIGHT"](../../../assets/firmware/split72-right-half.jpg)
