...
| Part | File |
|---|---|
| Left case | `case/case_polykybd_split72_left_r7.stl` |
| Right case | `case/case_polykybd_split72_right_r7.stl` |
| Spacer (×2) | `case/spacer.stl` |

<Aside type="tip">
Always grab the **latest** revision from the repo — `r7` is current at the time of writing. Older revisions are kept under `case/old_stls/` for reference only.
</Aside>
