...
| **idle** | steady green, fading out after a minute | `AI` / `idle` |
| **busy** | breathing amber, for as long as it takes | `AI` / `busy` |
| **needs you** | blinking red, fading out after a minute | `AI` / `you!` |
